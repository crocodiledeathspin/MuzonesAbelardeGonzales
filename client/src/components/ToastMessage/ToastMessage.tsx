...
const ToastMessage: FC<ToastMessageProps> = ({
    ...
    useEffect(() => {
        ...
        <>
            <div
                className={`fixed top-40 right-0 md:right-4 z-99999 flex items-center w-full max-w-xs p-4 mb-4 text-black
                ${
            ...
            >
                ...
                >
                    {isFailed ? (
                    <>
                        <svg className="w-5 h-5" aria-hidden="true" xmlns="http://w3.org" fill="currentColor" viewBox="0 0 20 20">
